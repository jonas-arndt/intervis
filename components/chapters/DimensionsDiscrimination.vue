<template>
  <div class="chapter concept-development">
    ...
    <p>
      Direkte/unmittelbare Diskriminierung liegt nach Definition des Allgemeinen Gleichbehandlungsgesetzes (AGG) dann vor, <span class="quote">wenn eine Person wegen eines in § 1 genannten Grundes [›Rasse‹, ethnische Herkunft, Geschlecht, Religion oder Weltanschauung, Behinderung, Alter oder sexuelle Identität] eine weniger günstige Behandlung erfährt, als eine andere Person in einer vergleichbaren Situation erfährt, erfahren hat oder erfahren würde</span> (§ 3 (1) AGG). Indirekte/mittelbare Diskriminierung liegt dann vor, <span class="quote">wenn dem Anschein nach neutrale Vorschriften, Kriterien oder Verfahren Personen wegen eines in § 1 genannten Grundes gegenüber anderen Personen in besonderer Weise benachteiligen können</span> (§ 3 (2) AGG).
    </p>

    <h3>Individuelle Dimension</h3>
    <p>
    ...
    <p>
      ...
      <br>So sind zum Beispiel spezifische Gruppen in bestimmten Sektoren oder Institutionen (z.B. in Förderschulen, in Gefängnissen, in bestimmten Arbeitssektoren) über- oder unterrepräsentiert. Diese Statistiken werden häufig falsch interpretiert oder sogar instrumentalisiert, wenn die strukturelle Dimension von Diskriminierung nicht mit einbezogen wird. Auch die Argumentation der <span class="quote">Umgekehrten Diskriminierung</span> ignoriert die strukturelle Dimension.
    </p>

    <h3>Institutionelle Dimension</h3>
    <p>
