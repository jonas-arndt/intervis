  ...
  <div class="case-study school">
    ...
    <div class="narrative">
      ...
      <div class="step">
        ...
        <p>
          2017 verklagte der 20-Jährige erfolgreich das Land Nordrhein-Westfalen, da er fälschlicherweise, als er 7 Jahre alt war, bei einem Einstufungstest als geistig behindert eingestuft wurde und daraufhin eine Förderschule besuchen musste. Zum Zeitpunkt des Testes konnte er nur Romanes sprechen, die Sprache der Rom*nja, was mit einer niedrigen Intelligenz gleichgesetzt wurde. Solche vermeintlich »neutralen« Methoden im Bildungssystem, welche z.B. mangelnde Sprachkenntnisse nicht adäquat berücksichtigen, führen in der Praxis dazu, dass beispielsweise bei Sinti*zze und Rom*nja Kindern unverhältnismäßig häufig – fälschlicherweise – besondere Bedürfnisse und Lernbehinderungen diagnostiziert werden und sie damit aufgrund ihrer Ethnizität und Klassenzugehörigkeit benachteiligt werden.
          <br>(Zitat von Nenand Mihailovic aus der → Dokumentation »Für dumm erklärt - Nenads zweite Chance« von 2018, Minute 0–36)
        </p>
        <p>
      ...
      <div class="step">
        ...
        <p>
          In der Tschechischen Republik stellte der Europäische Gerichtshof für Menschenrechte fest, dass es sich bei der stark überproportionalen Anzahl von Sinti*zze und Rom*nja Kindern an Förderschulen in Tschechien um indirekte Diskriminierung handelt, da vermeintlich »neutrale« Einstufungstests bestimmte Faktoren und Hintergründe – z.B. mangelnde Sprachkenntnisse – nicht berücksichtigen.
